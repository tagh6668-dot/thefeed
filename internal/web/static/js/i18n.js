...
var I18N = {
  fa: {
    ...
    backup_export: 'خروجی پشتیبان‌گیری',
    backup_import: 'بازیابی پشتیبان‌گیری',
    backup_profiles: 'پروفایل‌ها و تنظیمات',
    ...
    backup_export_btn: 'خروجی',
    backup_preview_btn: 'پیش‌نمایش',
    ...
    chat_err_no_key: 'هیچ پروفایلی کلید عمومی سرور (sk) ندارد؛ پیام‌رسان بدون آن فعال نمی‌شود.',
  ...
  en: {
    ...
    backup_profiles: 'Profiles & Settings',
    ...
    chat_err_no_key: 'None of your profiles have a server public key (sk); the messenger needs one to work.',
